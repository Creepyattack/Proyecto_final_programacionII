...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
             <!-- Brand -->
            <a class="navbar-brand" href="Puestos.jsp">Tabla de Puestos</a>
            <ul class="navbar-nav">
              <!-- Dropdown -->
      ...
      <div style="text-align: center;">
            <button type="button" class="btn btn-primary" id="nuevo" data-toggle="modal" data-target="#modal_puesto" onclick="limpiar()">Ingresar un registro</button>
            </div>
        <div class="container">
